...
\includegraphics[width=0.49\textwidth]{figures/CdTeEnergyI.pdf} 
...
about $15\%$ for electrons with an energy of $100$~GeV.
The measurement at 100 GeV is based on events with the electron impinging on
a 3~$\times$~3~mm area in the center of the sensor. 
A fiducial cut on the low energy data taken at T9 can not be applied due to the beam
divergence. 
