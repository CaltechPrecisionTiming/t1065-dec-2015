...
A Schottky type Cadmium-Telluride sensor with an active area of $1$~$\mathrm{cm}^{2}$ and a thickness of $1$~mm 
...
\keywords{ Timing Detectors, Solid State Detectors, Calorimeters, Photon detectors for UV, visible and IR photons (solid-state) }
