...
\section{Introduction} 
 ...
 %Outline
 % * Much recent interest in highly granular calorimeters with precision timing  capability for 
 %    future collider experiments with ability to deal with high pileup, cite  CMS HGCal
 % * silicon-based sampling calorimeters have been intensively studied, cite  CALICE, ILC, CMS HGCal
 % * We propose the first studies of using CdTe sensors for calorimeter in HEP. 
 %    * CdTe has been extensively studied in the context of thin film solar cells and is a mature technology. 
 %    * CdTe has been used as a radiation detector for nuclear spectroscopy, particularly efficient for x-rays
 %    * As it has very different quantum efficiency vs wavelength compared to silicon, we perform the first study  
 %       of its use as the active layer of a granular sampling calorimeter.
 % * We study the response of the CdTe sensor to electromagnetic showers of varying energies
 % * We study the timing performance of CdTe sensors
