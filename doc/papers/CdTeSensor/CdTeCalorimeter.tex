...
% first measurement of electromagnetic showers. 
% consistent with expectations, larger signals than for silicon?. 
% comparisons with simulation, and more detailed measurements of shower profiles will yield better quantitative conclusions

% the rise time of CdTe is relatively fast - 1.3ns. so there's intrinsic potential for excellent time precision
% time measurement has dependence on geometric position of the incident particle, likely due to charge collection path. 
%   this is a factor that needs to be further studied and optimized.
% correcting for these dependencies results in time precision of $20-25$~ps for a single layer 1cmx1cm sensor sampling
% the shower of a 200 GeV electron at 6 radiation lengths deep. 

% initial results are encouraging and motivate further in-depth studies.
