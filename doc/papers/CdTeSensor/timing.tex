...
is shown in the color scale. This data is from a 100 GeV electron beam after $X_0$ absorber.
The mean value of the time measured in the CdTe sensor 
as a function of the signal amplitude is shown in the black points. There is a small non-linearity we correct for.
...
of the beam particle position is shown in the black points. There is a dependency of the time difference
...
beam position in a 2 mm wide fiducial cut around the center of the sensor in the vertical (left) and horizontal (right) direction respectively. }
...
remains a dependency of the measured resolution across the sensor, reaching 20 ps in the location
